...
DEFALUT_ORIGIN_IATA = os.getenv("DEFAULT_ORIGIN_IATA", "BLR")
...
def clean_text(text: str) -> str:
    ...
    stop_words = [
        ...
        "plan", "complete", "days", "including", "hotel",
...
def parse_route(query: str):
    ...
    if len(mentions) == 1:
        ...
        return DEFALUT_ORIGIN_IATA, arr_iata
...
if __name__=="__main__":
    print(search_flights("Plan a 7 days Japan trip from Banglore"))
    print("\n" + "-" * 80 + "\n")
